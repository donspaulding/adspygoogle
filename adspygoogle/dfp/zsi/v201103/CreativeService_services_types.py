...
class ns0:
    ...
    class CreativeAssetMacroError_Def(TypeDefinition):
        ...
        def __init__(self, pname, ofwhat=(), extend=False, restrict=False, attributes=None, **kw):
            ...
            TClist = [GTD("https://www.google.com/apis/ads/publisher/v201103","CreativeAssetMacroError.Reason",lazy=False)(pname=(ns,"reason"), aname="_reason", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded"))]
            attributes = self.attribute_typecode_dict = attributes or {}
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
    ...
    class CustomCreativeError_Def(TypeDefinition):
        ...
        def __init__(self, pname, ofwhat=(), extend=False, restrict=False, attributes=None, **kw):
            ...
            TClist = [GTD("https://www.google.com/apis/ads/publisher/v201103","CustomCreativeError.Reason",lazy=False)(pname=(ns,"reason"), aname="_reason", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded"))]
            attributes = self.attribute_typecode_dict = attributes or {}
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
