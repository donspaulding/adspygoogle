...
class ns0:
    ...
    class FrequencyCapError_Def(TypeDefinition):
        ...
        def __init__(self, pname, ofwhat=(), extend=False, restrict=False, attributes=None, **kw):
            ...
            TClist = [GTD("https://www.google.com/apis/ads/publisher/v201010","FrequencyCapError.Reason",lazy=False)(pname=(ns,"reason"), aname="_reason", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded"))]
            attributes = self.attribute_typecode_dict = attributes or {}
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
    ...
    class InventoryUnitSizesError_Def(TypeDefinition):
        ...
        def __init__(self, pname, ofwhat=(), extend=False, restrict=False, attributes=None, **kw):
            ...
            TClist = [GTD("https://www.google.com/apis/ads/publisher/v201010","InventoryUnitSizesError.Reason",lazy=False)(pname=(ns,"reason"), aname="_reason", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded"))]
            attributes = self.attribute_typecode_dict = attributes or {}
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
    ...
    class PublisherQueryLanguageContextError_Def(TypeDefinition):
        ...
        def __init__(self, pname, ofwhat=(), extend=False, restrict=False, attributes=None, **kw):
            ...
            TClist = [GTD("https://www.google.com/apis/ads/publisher/v201010","PublisherQueryLanguageContextError.Reason",lazy=False)(pname=(ns,"reason"), aname="_reason", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded"))]
            attributes = self.attribute_typecode_dict = attributes or {}
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
    ...
    class PublisherQueryLanguageSyntaxError_Def(TypeDefinition):
        ...
        def __init__(self, pname, ofwhat=(), extend=False, restrict=False, attributes=None, **kw):
            ...
            TClist = [GTD("https://www.google.com/apis/ads/publisher/v201010","PublisherQueryLanguageSyntaxError.Reason",lazy=False)(pname=(ns,"reason"), aname="_reason", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded"))]
            attributes = self.attribute_typecode_dict = attributes or {}
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
