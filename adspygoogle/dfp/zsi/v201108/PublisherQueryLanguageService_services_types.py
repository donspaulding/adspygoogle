...
class ns0:
    ...
    class ResultSet_Def(ZSI.TCcompound.ComplexType, TypeDefinition):
        ...
        def __init__(self, pname, ofwhat=(), attributes=None, extend=False, restrict=False, **kw):
            ...
            TClist = [GTD("https://www.google.com/apis/ads/publisher/v201108","ColumnType",lazy=False)(pname=(ns,"columnTypes"), aname="_columnTypes", minOccurs=0, maxOccurs="unbounded", nillable=True, typed=False, encoded=kw.get("encoded")), GTD("https://www.google.com/apis/ads/publisher/v201108","Row",lazy=False)(pname=(ns,"rows"), aname="_rows", minOccurs=0, maxOccurs="unbounded", nillable=True, typed=False, encoded=kw.get("encoded"))]
            self.attribute_typecode_dict = attributes or {}
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
            ZSI.TCcompound.ComplexType.__init__(self, None, TClist, pname=pname, inorder=0, **kw)
    ...
    class Row_Def(ZSI.TCcompound.ComplexType, TypeDefinition):
        ...
        def __init__(self, pname, ofwhat=(), attributes=None, extend=False, restrict=False, **kw):
            ...
            TClist = [GTD("https://www.google.com/apis/ads/publisher/v201108","Value",lazy=False)(pname=(ns,"values"), aname="_values", minOccurs=0, maxOccurs="unbounded", nillable=True, typed=False, encoded=kw.get("encoded"))]
            self.attribute_typecode_dict = attributes or {}
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
            ZSI.TCcompound.ComplexType.__init__(self, None, TClist, pname=pname, inorder=0, **kw)
    ...
    class select_Dec(ZSI.TCcompound.ComplexType, ElementDeclaration):
        ...
        def __init__(self, **kw):
            ...
            TClist = [GTD("https://www.google.com/apis/ads/publisher/v201108","Statement",lazy=False)(pname=(ns,"selectStatement"), aname="_selectStatement", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded"))]
            kw["pname"] = ("https://www.google.com/apis/ads/publisher/v201108","select")
            kw["aname"] = "_select"
    ...
    class selectResponse_Dec(ZSI.TCcompound.ComplexType, ElementDeclaration):
        ...
        def __init__(self, **kw):
            ...
            TClist = [GTD("https://www.google.com/apis/ads/publisher/v201108","ResultSet",lazy=False)(pname=(ns,"rval"), aname="_rval", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded"))]
            kw["pname"] = ("https://www.google.com/apis/ads/publisher/v201108","selectResponse")
