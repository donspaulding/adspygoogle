...
class ns0:
    ...
    class BaseFlashRedirectCreative_Def(TypeDefinition):
        ...
        def __init__(self, pname, ofwhat=(), extend=False, restrict=False, attributes=None, **kw):
            ...
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
            if ns0.HasDestinationUrlCreative_Def not in ns0.BaseFlashRedirectCreative_Def.__bases__:
                bases = list(ns0.BaseFlashRedirectCreative_Def.__bases__)
                bases.insert(0, ns0.HasDestinationUrlCreative_Def)
                ns0.BaseFlashRedirectCreative_Def.__bases__ = tuple(bases)

            ns0.HasDestinationUrlCreative_Def.__init__(self, pname, ofwhat=TClist, extend=True, attributes=attributes, **kw)

    class BaseImageCreative_Def(TypeDefinition):
        #complexType/complexContent extension
        schema = "https://www.google.com/apis/ads/publisher/v201107"
        type = (schema, "BaseImageCreative")
        def __init__(self, pname, ofwhat=(), extend=False, restrict=False, attributes=None, **kw):
            ns = ns0.BaseImageCreative_Def.schema
            TClist = [ZSI.TC.String(pname=(ns,"imageName"), aname="_imageName", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded")), ZSI.TC.Base64String(pname=(ns,"imageByteArray"), aname="_imageByteArray", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname=(ns,"overrideSize"), aname="_overrideSize", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded")), GTD("https://www.google.com/apis/ads/publisher/v201107","Size",lazy=False)(pname=(ns,"assetSize"), aname="_assetSize", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname=(ns,"imageUrl"), aname="_imageUrl", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded"))]
            attributes = self.attribute_typecode_dict = attributes or {}
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
            if ns0.HasDestinationUrlCreative_Def not in ns0.BaseImageCreative_Def.__bases__:
                bases = list(ns0.BaseImageCreative_Def.__bases__)
                bases.insert(0, ns0.HasDestinationUrlCreative_Def)
                ns0.BaseImageCreative_Def.__bases__ = tuple(bases)

            ns0.HasDestinationUrlCreative_Def.__init__(self, pname, ofwhat=TClist, extend=True, attributes=attributes, **kw)

    class BaseImageRedirectCreative_Def(TypeDefinition):
        #complexType/complexContent extension
        schema = "https://www.google.com/apis/ads/publisher/v201107"
        type = (schema, "BaseImageRedirectCreative")
        def __init__(self, pname, ofwhat=(), extend=False, restrict=False, attributes=None, **kw):
            ns = ns0.BaseImageRedirectCreative_Def.schema
            ...
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
            if ns0.HasDestinationUrlCreative_Def not in ns0.BaseImageRedirectCreative_Def.__bases__:
                bases = list(ns0.BaseImageRedirectCreative_Def.__bases__)
                bases.insert(0, ns0.HasDestinationUrlCreative_Def)
                ns0.BaseImageRedirectCreative_Def.__bases__ = tuple(bases)
    ...
    class ClickTrackingCreative_Def(TypeDefinition):
        #complexType/complexContent extension
        schema = "https://www.google.com/apis/ads/publisher/v201107"
        type = (schema, "ClickTrackingCreative")
        def __init__(self, pname, ofwhat=(), extend=False, restrict=False, attributes=None, **kw):
            ns = ns0.ClickTrackingCreative_Def.schema
            TClist = [ZSI.TC.String(pname=(ns,"clickTrackingUrl"), aname="_clickTrackingUrl", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded"))]
            attributes = self.attribute_typecode_dict = attributes or {}
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
            if ns0.Creative_Def not in ns0.ClickTrackingCreative_Def.__bases__:
                bases = list(ns0.ClickTrackingCreative_Def.__bases__)
                bases.insert(0, ns0.Creative_Def)
                ns0.ClickTrackingCreative_Def.__bases__ = tuple(bases)
    ...
    class CreativeAssetMacroError_Def(TypeDefinition):
        #complexType/complexContent extension
        schema = "https://www.google.com/apis/ads/publisher/v201107"
        type = (schema, "CreativeAssetMacroError")
        def __init__(self, pname, ofwhat=(), extend=False, restrict=False, attributes=None, **kw):
            ns = ns0.CreativeAssetMacroError_Def.schema
            TClist = [GTD("https://www.google.com/apis/ads/publisher/v201107","CreativeAssetMacroError.Reason",lazy=False)(pname=(ns,"reason"), aname="_reason", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded"))]
            attributes = self.attribute_typecode_dict = attributes or {}
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
            if ns0.ApiError_Def not in ns0.CreativeAssetMacroError_Def.__bases__:
                bases = list(ns0.CreativeAssetMacroError_Def.__bases__)
                bases.insert(0, ns0.ApiError_Def)
                ns0.CreativeAssetMacroError_Def.__bases__ = tuple(bases)
    ...
    class Creative_Def(ZSI.TCcompound.ComplexType, TypeDefinition):
        ...
        def __init__(self, pname, ofwhat=(), attributes=None, extend=False, restrict=False, **kw):
            ...
            TClist = [ZSI.TC.String(pname=(ns,"advertiserId"), aname="_advertiserId", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname=(ns,"id"), aname="_id", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname=(ns,"name"), aname="_name", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded")), GTD("https://www.google.com/apis/ads/publisher/v201107","Size",lazy=False)(pname=(ns,"size"), aname="_size", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname=(ns,"previewUrl"), aname="_previewUrl", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded")), GTD("https://www.google.com/apis/ads/publisher/v201107","AppliedLabel",lazy=False)(pname=(ns,"appliedLabels"), aname="_appliedLabels", minOccurs=0, maxOccurs="unbounded", nillable=True, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname=(ns,"Creative.Type"), aname="_Creative_Type", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded"))]
            self.attribute_typecode_dict = attributes or {}
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
            ZSI.TCcompound.ComplexType.__init__(self, None, TClist, pname=pname, inorder=0, **kw)
    ...
    class CreativeError_Def(TypeDefinition):
        ...
        def __init__(self, pname, ofwhat=(), extend=False, restrict=False, attributes=None, **kw):
            ...
            TClist = [GTD("https://www.google.com/apis/ads/publisher/v201107","CreativeError.Reason",lazy=False)(pname=(ns,"reason"), aname="_reason", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded"))]
            attributes = self.attribute_typecode_dict = attributes or {}
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
    ...
    class CreativePage_Def(ZSI.TCcompound.ComplexType, TypeDefinition):
        ...
        def __init__(self, pname, ofwhat=(), attributes=None, extend=False, restrict=False, **kw):
            ...
            TClist = [ZSI.TC.String(pname=(ns,"totalResultSetSize"), aname="_totalResultSetSize", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname=(ns,"startIndex"), aname="_startIndex", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded")), GTD("https://www.google.com/apis/ads/publisher/v201107","Creative",lazy=False)(pname=(ns,"results"), aname="_results", minOccurs=0, maxOccurs="unbounded", nillable=True, typed=False, encoded=kw.get("encoded"))]
            self.attribute_typecode_dict = attributes or {}
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
            ZSI.TCcompound.ComplexType.__init__(self, None, TClist, pname=pname, inorder=0, **kw)
    ...
    class CustomCreativeError_Def(TypeDefinition):
        #complexType/complexContent extension
        schema = "https://www.google.com/apis/ads/publisher/v201107"
        type = (schema, "CustomCreativeError")
        def __init__(self, pname, ofwhat=(), extend=False, restrict=False, attributes=None, **kw):
            ns = ns0.CustomCreativeError_Def.schema
            TClist = [GTD("https://www.google.com/apis/ads/publisher/v201107","CustomCreativeError.Reason",lazy=False)(pname=(ns,"reason"), aname="_reason", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded"))]
            attributes = self.attribute_typecode_dict = attributes or {}
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
            if ns0.ApiError_Def not in ns0.CustomCreativeError_Def.__bases__:
                bases = list(ns0.CustomCreativeError_Def.__bases__)
                bases.insert(0, ns0.ApiError_Def)
                ns0.CustomCreativeError_Def.__bases__ = tuple(bases)
    ...
    class FileError_Def(TypeDefinition):
        ...
        def __init__(self, pname, ofwhat=(), extend=False, restrict=False, attributes=None, **kw):
            ...
            TClist = [GTD("https://www.google.com/apis/ads/publisher/v201107","FileError.Reason",lazy=False)(pname=(ns,"reason"), aname="_reason", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded"))]
            attributes = self.attribute_typecode_dict = attributes or {}
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
    ...
    class FlashCreative_Def(TypeDefinition):
        ...
        def __init__(self, pname, ofwhat=(), extend=False, restrict=False, attributes=None, **kw):
            ...
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
            if ns0.BaseFlashCreative_Def not in ns0.FlashCreative_Def.__bases__:
                bases = list(ns0.FlashCreative_Def.__bases__)
                bases.insert(0, ns0.BaseFlashCreative_Def)
                ns0.FlashCreative_Def.__bases__ = tuple(bases)

            ns0.BaseFlashCreative_Def.__init__(self, pname, ofwhat=TClist, extend=True, attributes=attributes, **kw)
    ...
    class FlashRedirectCreative_Def(TypeDefinition):
        ...
        def __init__(self, pname, ofwhat=(), extend=False, restrict=False, attributes=None, **kw):
            ...
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
            if ns0.BaseFlashRedirectCreative_Def not in ns0.FlashRedirectCreative_Def.__bases__:
                bases = list(ns0.FlashRedirectCreative_Def.__bases__)
                bases.insert(0, ns0.BaseFlashRedirectCreative_Def)
                ns0.FlashRedirectCreative_Def.__bases__ = tuple(bases)

            ns0.BaseFlashRedirectCreative_Def.__init__(self, pname, ofwhat=TClist, extend=True, attributes=attributes, **kw)
    ...
    class ImageCreative_Def(TypeDefinition):
        ...
        def __init__(self, pname, ofwhat=(), extend=False, restrict=False, attributes=None, **kw):
            ...
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
            if ns0.BaseImageCreative_Def not in ns0.ImageCreative_Def.__bases__:
                bases = list(ns0.ImageCreative_Def.__bases__)
                bases.insert(0, ns0.BaseImageCreative_Def)
                ns0.ImageCreative_Def.__bases__ = tuple(bases)

            ns0.BaseImageCreative_Def.__init__(self, pname, ofwhat=TClist, extend=True, attributes=attributes, **kw)
    ...
    class ImageError_Def(TypeDefinition):
        ...
        def __init__(self, pname, ofwhat=(), extend=False, restrict=False, attributes=None, **kw):
            ...
            TClist = [GTD("https://www.google.com/apis/ads/publisher/v201107","ImageError.Reason",lazy=False)(pname=(ns,"reason"), aname="_reason", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded"))]
            attributes = self.attribute_typecode_dict = attributes or {}
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
    ...
    class ImageRedirectCreative_Def(TypeDefinition):
        ...
        def __init__(self, pname, ofwhat=(), extend=False, restrict=False, attributes=None, **kw):
            ...
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
            if ns0.BaseImageRedirectCreative_Def not in ns0.ImageRedirectCreative_Def.__bases__:
                bases = list(ns0.ImageRedirectCreative_Def.__bases__)
                bases.insert(0, ns0.BaseImageRedirectCreative_Def)
                ns0.ImageRedirectCreative_Def.__bases__ = tuple(bases)

            ns0.BaseImageRedirectCreative_Def.__init__(self, pname, ofwhat=TClist, extend=True, attributes=attributes, **kw)
    ...
    class InvalidUrlError_Def(TypeDefinition):
        ...
        def __init__(self, pname, ofwhat=(), extend=False, restrict=False, attributes=None, **kw):
            ...
            TClist = [GTD("https://www.google.com/apis/ads/publisher/v201107","InvalidUrlError.Reason",lazy=False)(pname=(ns,"reason"), aname="_reason", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded"))]
            attributes = self.attribute_typecode_dict = attributes or {}
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
    ...
    class RequiredSizeError_Def(TypeDefinition):
        ...
        def __init__(self, pname, ofwhat=(), extend=False, restrict=False, attributes=None, **kw):
            ...
            TClist = [GTD("https://www.google.com/apis/ads/publisher/v201107","RequiredSizeError.Reason",lazy=False)(pname=(ns,"reason"), aname="_reason", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded"))]
            attributes = self.attribute_typecode_dict = attributes or {}
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
    ...
    class CreativeAssetMacroError_Reason_Def(ZSI.TC.String, TypeDefinition):
        schema = "https://www.google.com/apis/ads/publisher/v201107"
        type = (schema, "CreativeAssetMacroError.Reason")
        def __init__(self, pname, **kw):
            ZSI.TC.String.__init__(self, pname, pyclass=None, **kw)
            class Holder(str):
                typecode = self
    ...
    class CustomCreativeError_Reason_Def(ZSI.TC.String, TypeDefinition):
        schema = "https://www.google.com/apis/ads/publisher/v201107"
        type = (schema, "CustomCreativeError.Reason")
        def __init__(self, pname, **kw):
            ZSI.TC.String.__init__(self, pname, pyclass=None, **kw)
            class Holder(str):
                typecode = self
    ...
    class createCreative_Dec(ZSI.TCcompound.ComplexType, ElementDeclaration):
        ...
        def __init__(self, **kw):
            ...
            TClist = [GTD("https://www.google.com/apis/ads/publisher/v201107","Creative",lazy=False)(pname=(ns,"creative"), aname="_creative", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded"))]
            kw["pname"] = ("https://www.google.com/apis/ads/publisher/v201107","createCreative")
    ...
    class createCreativeResponse_Dec(ZSI.TCcompound.ComplexType, ElementDeclaration):
        ...
        def __init__(self, **kw):
            ...
            TClist = [GTD("https://www.google.com/apis/ads/publisher/v201107","Creative",lazy=False)(pname=(ns,"rval"), aname="_rval", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded"))]
            kw["pname"] = ("https://www.google.com/apis/ads/publisher/v201107","createCreativeResponse")
    ...
    class createCreatives_Dec(ZSI.TCcompound.ComplexType, ElementDeclaration):
        ...
        def __init__(self, **kw):
            ...
            TClist = [GTD("https://www.google.com/apis/ads/publisher/v201107","Creative",lazy=False)(pname=(ns,"creatives"), aname="_creatives", minOccurs=0, maxOccurs="unbounded", nillable=True, typed=False, encoded=kw.get("encoded"))]
            kw["pname"] = ("https://www.google.com/apis/ads/publisher/v201107","createCreatives")
    ...
    class createCreativesResponse_Dec(ZSI.TCcompound.ComplexType, ElementDeclaration):
        ...
        def __init__(self, **kw):
            ...
            TClist = [GTD("https://www.google.com/apis/ads/publisher/v201107","Creative",lazy=False)(pname=(ns,"rval"), aname="_rval", minOccurs=0, maxOccurs="unbounded", nillable=True, typed=False, encoded=kw.get("encoded"))]
            kw["pname"] = ("https://www.google.com/apis/ads/publisher/v201107","createCreativesResponse")
    ...
    class getCreative_Dec(ZSI.TCcompound.ComplexType, ElementDeclaration):
        ...
        def __init__(self, **kw):
            ...
            kw["pname"] = ("https://www.google.com/apis/ads/publisher/v201107","getCreative")
    ...
    class getCreativeResponse_Dec(ZSI.TCcompound.ComplexType, ElementDeclaration):
        ...
        def __init__(self, **kw):
            ...
            TClist = [GTD("https://www.google.com/apis/ads/publisher/v201107","Creative",lazy=False)(pname=(ns,"rval"), aname="_rval", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded"))]
            kw["pname"] = ("https://www.google.com/apis/ads/publisher/v201107","getCreativeResponse")
    ...
    class getCreativesByStatement_Dec(ZSI.TCcompound.ComplexType, ElementDeclaration):
        ...
        def __init__(self, **kw):
            ...
            kw["pname"] = ("https://www.google.com/apis/ads/publisher/v201107","getCreativesByStatement")
    ...
    class getCreativesByStatementResponse_Dec(ZSI.TCcompound.ComplexType, ElementDeclaration):
        ...
        def __init__(self, **kw):
            ...
            TClist = [GTD("https://www.google.com/apis/ads/publisher/v201107","CreativePage",lazy=False)(pname=(ns,"rval"), aname="_rval", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded"))]
            kw["pname"] = ("https://www.google.com/apis/ads/publisher/v201107","getCreativesByStatementResponse")
    ...
    class updateCreative_Dec(ZSI.TCcompound.ComplexType, ElementDeclaration):
        ...
        def __init__(self, **kw):
            ...
            TClist = [GTD("https://www.google.com/apis/ads/publisher/v201107","Creative",lazy=False)(pname=(ns,"creative"), aname="_creative", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded"))]
            kw["pname"] = ("https://www.google.com/apis/ads/publisher/v201107","updateCreative")
    ...
    class updateCreativeResponse_Dec(ZSI.TCcompound.ComplexType, ElementDeclaration):
        ...
        def __init__(self, **kw):
            ...
            TClist = [GTD("https://www.google.com/apis/ads/publisher/v201107","Creative",lazy=False)(pname=(ns,"rval"), aname="_rval", minOccurs=0, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded"))]
            kw["pname"] = ("https://www.google.com/apis/ads/publisher/v201107","updateCreativeResponse")
    ...
    class updateCreatives_Dec(ZSI.TCcompound.ComplexType, ElementDeclaration):
        ...
        def __init__(self, **kw):
            ...
            TClist = [GTD("https://www.google.com/apis/ads/publisher/v201107","Creative",lazy=False)(pname=(ns,"creatives"), aname="_creatives", minOccurs=0, maxOccurs="unbounded", nillable=True, typed=False, encoded=kw.get("encoded"))]
            kw["pname"] = ("https://www.google.com/apis/ads/publisher/v201107","updateCreatives")
    ...
    class updateCreativesResponse_Dec(ZSI.TCcompound.ComplexType, ElementDeclaration):
        ...
        def __init__(self, **kw):
            ...
            TClist = [GTD("https://www.google.com/apis/ads/publisher/v201107","Creative",lazy=False)(pname=(ns,"rval"), aname="_rval", minOccurs=0, maxOccurs="unbounded", nillable=True, typed=False, encoded=kw.get("encoded"))]
            kw["pname"] = ("https://www.google.com/apis/ads/publisher/v201107","updateCreativesResponse")
