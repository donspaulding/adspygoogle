...
class ns0:
    ...
    class getAdUnitSizesResponse_Dec(ZSI.TCcompound.ComplexType, ElementDeclaration):
        ...
        def __init__(self, **kw):
            ...
            TClist = [GTD("https://www.google.com/apis/ads/publisher/v201107","AdUnitSize",lazy=True)(pname=(ns,"rval"), aname="_rval", minOccurs=0, maxOccurs="unbounded", nillable=True, typed=False, encoded=kw.get("encoded"))]
