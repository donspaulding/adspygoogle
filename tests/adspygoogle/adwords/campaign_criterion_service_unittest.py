...
class CampaignCriterionServiceTestV201101(unittest.TestCase):

  """Unittest suite for CampaignCriterionService using v201101."""
...
def makeTestSuiteV201101():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(CampaignCriterionServiceTestV201101))
  return suite
