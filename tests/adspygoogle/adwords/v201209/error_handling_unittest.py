...
from examples.adspygoogle.adwords.v201209.error_handling import handle_partial_failures
from examples.adspygoogle.adwords.v201209.error_handling import handle_two_factor_authorization_error
