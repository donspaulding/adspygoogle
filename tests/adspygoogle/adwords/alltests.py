...
for test in tests:
  ...
  for name, obj in inspect.getmembers(module):
    if inspect.isclass(obj):
      if ((name.endswith('13') and TEST_VERSION_V13) or
          (name.endswith('200909') and TEST_VERSION_V200909) or
          (name.endswith('201003') and TEST_VERSION_V201003) or
          (name.endswith('201008') and TEST_VERSION_V201008) or
          (name.endswith('201101') and TEST_VERSION_V201101)):
