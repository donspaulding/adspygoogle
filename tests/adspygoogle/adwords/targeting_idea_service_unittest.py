...
class TargetingIdeaServiceTestV200909(unittest.TestCase):
  ...
  def testGetEmptySelector(self):
    ...
    try:
      ...
      self.failUnless(str(e).find(self.__class__.TRIGGER_MSG) > -1)
...
class TargetingIdeaServiceTestV201109(unittest.TestCase):
  ...
  def testGetLocationSearchParameter(self):
    """Test whether we can request country target search parameter."""
    selector = {
        'searchParameters': [
            {
  ...
  def testGetLanguageSearchParameter(self):
    """Test whether we can request language target search parameter."""
    selector = {
        'searchParameters': [
            {
