...
class AdWordsErrorsTestV201101(unittest.TestCase):

  """Unittest suite for AdWordsErrors using v201101."""
...
def makeTestSuiteV201101():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(AdWordsErrorsTestV201101))
  return suite
