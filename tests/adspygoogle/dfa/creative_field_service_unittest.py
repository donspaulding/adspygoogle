...
class CreativeFieldServiceTestV1_11(unittest.TestCase):

  """Unittest suite for CreativeFieldService using v1_11."""
...
def makeTestSuiteV1_11():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(CreativeFieldServiceTestV1_11))
  return suite
