...
class PlacementServiceTestV1_14(unittest.TestCase):
  ...
  """Unittest suite for PlacementService using v1_14."""
...
class PlacementServiceTestV1_16(unittest.TestCase):

  """Unittest suite for PlacementService using v1_16."""
...
def makeTestSuiteV1_14():
  ...
  suite.addTests(unittest.makeSuite(PlacementServiceTestV1_14))
  return suite
...
def makeTestSuiteV1_16():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(PlacementServiceTestV1_16))
  return suite
