...
class CampaignServiceTestV1_15(unittest.TestCase):

  """Unittest suite for CampaignService using v1_15."""
...
def makeTestSuiteV1_15():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(CampaignServiceTestV1_15))
  return suite
