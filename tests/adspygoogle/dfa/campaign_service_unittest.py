...
class CampaignServiceTestV1_13(unittest.TestCase):

  """Unittest suite for CampaignService using v1_13."""
...
class CampaignServiceTestV1_12(unittest.TestCase):

  """Unittest suite for CampaignService using v1_12."""
...
class CampaignServiceTestV1_11(unittest.TestCase):

  """Unittest suite for CampaignService using v1_11."""
...
def makeTestSuiteV1_13():
  ...
  suite.addTests(unittest.makeSuite(CampaignServiceTestV1_13))
  return suite
...
def makeTestSuiteV1_12():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(CampaignServiceTestV1_12))
  return suite
...
def makeTestSuiteV1_11():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(CampaignServiceTestV1_11))
  return suite
