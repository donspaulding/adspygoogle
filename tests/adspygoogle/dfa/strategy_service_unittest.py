...
class StrategyServiceTestV1_16(unittest.TestCase):

  """Unittest suite for StrategyService using v1_16."""
...
def makeTestSuiteV1_16():
  ...
  suite.addTests(unittest.makeSuite(StrategyServiceTestV1_16))
  return suite
