...
class UserRoleServiceTestV1_16(unittest.TestCase):

  """Unittest suite for UserRoleService using v1_16."""
...
def makeTestSuiteV1_16():
  ...
  suite.addTests(unittest.makeSuite(UserRoleServiceTestV1_16))
  return suite
