...
class SpotlightServiceTestV1_14(unittest.TestCase):

  """Unittest suite for SpotlightService using v1_14."""
...
class SpotlightServiceTestV1_15(unittest.TestCase):

  """Unittest suite for SpotlightService using v1_15."""
...
def makeTestSuiteV1_14():
  ...
  suite.addTests(unittest.makeSuite(SpotlightServiceTestV1_14))
  return suite
...
def makeTestSuiteV1_15():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(SpotlightServiceTestV1_15))
  return suite
