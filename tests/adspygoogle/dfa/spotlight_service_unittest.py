...
class SpotlightServiceTestV1_12(unittest.TestCase):

  """Unittest suite for SpotlightService using v1_12."""
...
def makeTestSuiteV1_12():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(SpotlightServiceTestV1_12))
  return suite
