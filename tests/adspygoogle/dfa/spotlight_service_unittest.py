...
class SpotlightServiceTestV1_11(unittest.TestCase):

  """Unittest suite for SpotlightService using v1_11."""
...
def makeTestSuiteV1_11():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(SpotlightServiceTestV1_11))
  return suite
