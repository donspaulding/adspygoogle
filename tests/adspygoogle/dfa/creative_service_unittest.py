...
class CreativeServiceTestV1_14(unittest.TestCase):

  """Unittest suite for CreativeService using v1_14."""
  ...
  def testAssignCreativeGroupsToCreative(self):
    """Test whether we can assign creative groups to a creative."""
    if self.__class__.creative_id == '0':
      self.testSaveCreative()
    campaign_id = self.__class__.campaign['id']
    creative_id = self.__class__.creative_id
    creative_group_id = self.__class__.creative_group_id
    self.assertEqual(self.__class__.service.AssignCreativeGroupsToCreative(
        campaign_id, creative_id, [creative_group_id]), None)
  ...
  def testGetAssignedCreativeGroupsToCreative(self):
    """Test whether we can fetch the creative groups assigned to a creative."""
    if self.__class__.creative_id == '0':
      self.testSaveCreative()
    campaign_id = self.__class__.campaign['id']
    creative_id = self.__class__.creative_id
    self.assert_(isinstance(
        self.__class__.service.GetAssignedCreativeGroupsToCreative(
            campaign_id, creative_id), tuple))
...
class CreativeServiceTestV1_13(unittest.TestCase):

  """Unittest suite for CreativeService using v1_13."""
...
class CreativeServiceTestV1_12(unittest.TestCase):

  """Unittest suite for CreativeService using v1_12."""
...
def makeTestSuiteV1_14():
  ...
  suite.addTests(unittest.makeSuite(CreativeServiceTestV1_14))
  return suite
...
def makeTestSuiteV1_13():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(CreativeServiceTestV1_13))
  return suite
...
def makeTestSuiteV1_12():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(CreativeServiceTestV1_12))
  return suite
