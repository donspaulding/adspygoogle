...
class CreativeServiceTestV1_16(unittest.TestCase):

  """Unittest suite for CreativeService using v1_16."""
...
class CreativeServiceTestV1_15(unittest.TestCase):

  """Unittest suite for CreativeService using v1_15."""
...
def makeTestSuiteV1_16():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(CreativeServiceTestV1_16))
  return suite
...
def makeTestSuiteV1_15():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(CreativeServiceTestV1_15))
  return suite
