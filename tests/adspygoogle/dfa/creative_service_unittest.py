...
class CreativeServiceTestV1_11(unittest.TestCase):

  """Unittest suite for CreativeService using v1_11."""
...
def makeTestSuiteV1_11():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(CreativeServiceTestV1_11))
  return suite
