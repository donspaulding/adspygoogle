...
class SubnetworkServiceTestV1_12(unittest.TestCase):

  """Unittest suite for SubnetworkService using v1_12."""
...
class SubnetworkServiceTestV1_11(unittest.TestCase):

  """Unittest suite for SubnetworkService using v1_11."""
...
def makeTestSuiteV1_12():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(SubnetworkServiceTestV1_12))
  return suite
...
def makeTestSuiteV1_11():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(SubnetworkServiceTestV1_11))
  return suite
