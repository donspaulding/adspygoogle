...
class SubnetworkServiceTestV1_16(unittest.TestCase):

  """Unittest suite for SubnetworkService using v1_16."""
...
def makeTestSuiteV1_16():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(SubnetworkServiceTestV1_16))
  return suite
