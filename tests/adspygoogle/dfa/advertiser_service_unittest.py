...
class AdvertiserServiceTestV1_12(unittest.TestCase):

  """Unittest suite for AdvertiserService using v1_12."""
...
def makeTestSuiteV1_12():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(AdvertiserServiceTestV1_12))
  return suite
