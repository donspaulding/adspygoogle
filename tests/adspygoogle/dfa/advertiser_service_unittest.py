...
class AdvertiserServiceTestV1_16(unittest.TestCase):

  """Unittest suite for AdvertiserService using v1_16."""
...
def makeTestSuiteV1_16():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(AdvertiserServiceTestV1_16))
  return suite
