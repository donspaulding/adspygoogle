...
class AdServiceTestV1_14(unittest.TestCase):

  """Unittest suite for AdService using v1_14."""
  ...
  def testSaveAd(self):
    ...
    end_date = (str(int(end_date_before[0:4]) + 1) + end_date_before[4:8] +
                str(int(end_date_before[8:10]) - 1) + end_date_before[10:])
    ad = {
...
class AdServiceTestV1_16(unittest.TestCase):

  """Unittest suite for AdService using v1_16."""
...
class AdServiceTestV1_15(unittest.TestCase):

  """Unittest suite for AdService using v1_15."""
...
def makeTestSuiteV1_14():
  ...
  suite.addTests(unittest.makeSuite(AdServiceTestV1_14))
  return suite
...
def makeTestSuiteV1_16():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(AdServiceTestV1_16))
  return suite
...
def makeTestSuiteV1_15():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(AdServiceTestV1_15))
  return suite
