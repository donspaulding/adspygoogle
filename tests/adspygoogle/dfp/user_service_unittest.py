...
class UserServiceTestV201104(unittest.TestCase):

  """Unittest suite for UserService using v201104."""
...
class UserServiceTestV201107(unittest.TestCase):

  """Unittest suite for UserService using v201107."""
...
def makeTestSuiteV201104():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(UserServiceTestV201104))
  return suite
...
def makeTestSuiteV201107():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(UserServiceTestV201107))
  return suite
