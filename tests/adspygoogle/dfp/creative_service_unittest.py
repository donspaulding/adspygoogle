...
class CreativeServiceTestV201104(unittest.TestCase):

  """Unittest suite for CreativeService using v201104."""
  ...
  def testGetCreative(self):
    ...
    self.assert_(isinstance(self.__class__.service.GetCreative(
        self.__class__.creative1['id']), tuple))
    self.assertEqual(self.__class__.service.GetCreative(
        self.__class__.creative1['id'])[0]['Creative_Type'], 'ImageCreative')
...
class CreativeServiceTestV201107(unittest.TestCase):

  """Unittest suite for CreativeService using v201107."""
...
def makeTestSuiteV201104():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(CreativeServiceTestV201104))
  return suite
...
def makeTestSuiteV201107():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(CreativeServiceTestV201107))
  return suite
