...
class CompanyServiceTestV201104(unittest.TestCase):

  """Unittest suite for CompanyService using v201104."""
...
class CompanyServiceTestV201107(unittest.TestCase):

  """Unittest suite for CompanyService using v201107."""
...
def makeTestSuiteV201104():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(CompanyServiceTestV201104))
  return suite
...
def makeTestSuiteV201107():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(CompanyServiceTestV201107))
  return suite
