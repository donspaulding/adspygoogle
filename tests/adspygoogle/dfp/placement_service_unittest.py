...
class PlacementServiceTestV201104(unittest.TestCase):

  """Unittest suite for PlacementService using v201104."""
...
class PlacementServiceTestV201107(unittest.TestCase):

  """Unittest suite for PlacementService using v201107."""
...
def makeTestSuiteV201104():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(PlacementServiceTestV201104))
  return suite
...
def makeTestSuiteV201107():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(PlacementServiceTestV201107))
  return suite
