...
class LineItemServiceTestV201104(unittest.TestCase):

  """Unittest suite for LineItemService using v201104."""
...
class LineItemServiceTestV201107(unittest.TestCase):

  """Unittest suite for LineItemService using v201107."""
...
def makeTestSuiteV201104():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(LineItemServiceTestV201104))
  return suite
...
def makeTestSuiteV201107():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(LineItemServiceTestV201107))
  return suite
