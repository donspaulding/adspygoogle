...
class CustomTargetingServiceTestV201104(unittest.TestCase):

  """Unittest suite for CustomTargetingService using v201104."""
...
class CustomTargetingServiceTestV201107(unittest.TestCase):

  """Unittest suite for CustomTargetingService using v201107."""
...
def makeTestSuiteV201104():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(CustomTargetingServiceTestV201104))
  return suite
...
def makeTestSuiteV201107():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(CustomTargetingServiceTestV201107))
  return suite
