...
class LicaServiceTestV201104(unittest.TestCase):

  """Unittest suite for LineItemCreativeAssociationService using V201104."""
...
class LicaServiceTestV201107(unittest.TestCase):

  """Unittest suite for LineItemCreativeAssociationService using V201107."""
...
def makeTestSuiteV201104():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(LicaServiceTestV201104))
  return suite
...
def makeTestSuiteV201107():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(LicaServiceTestV201107))
  return suite
