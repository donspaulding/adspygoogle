...
class LabelServiceTestV201107(unittest.TestCase):

  """Unittest suite for LabelService using v201107."""
...
def makeTestSuiteV201107():
  ...
  suite.addTests(unittest.makeSuite(LabelServiceTestV201107))
  return suite
...
if __name__ == '__main__':
  ...
  alltests = unittest.TestSuite([suite_v201107, suite_v201108])
