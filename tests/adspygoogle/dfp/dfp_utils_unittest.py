...
class DfpUtilsTestV201104(unittest.TestCase):

  """Unittest suite for DfpUtils using v201104."""
...
class DfpUtilsTestV201107(unittest.TestCase):

  """Unittest suite for DfpUtils using v201107."""
...
def makeTestSuiteV201107():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(DfpUtilsTestV201107))
  return suite
