...
class ForecastServiceTestV201104(unittest.TestCase):

  """Unittest suite for ForecastService using v201104."""
...
class ForecastServiceTestV201107(unittest.TestCase):

  """Unittest suite for ForecastService using v201107."""
...
def makeTestSuiteV201104():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(ForecastServiceTestV201104))
  return suite
...
def makeTestSuiteV201107():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(ForecastServiceTestV201107))
  return suite
