...
class OrderServiceTestV201104(unittest.TestCase):

  """Unittest suite for OrderService using v201104."""
...
class OrderServiceTestV201107(unittest.TestCase):

  """Unittest suite for OrderService using v201107."""
...
def makeTestSuiteV201104():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(OrderServiceTestV201104))
  return suite
...
def makeTestSuiteV201107():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(OrderServiceTestV201107))
  return suite
