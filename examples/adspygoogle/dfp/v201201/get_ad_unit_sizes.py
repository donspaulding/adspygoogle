...
inventory_service = client.GetService(
    'InventoryService', 'https://sandbox.google.com', 'v201201')

# Get ad unit sizes.
ad_unit_sizes = inventory_service.GetAdUnitSizes()

# Display results.
for ad_unit_size in ad_unit_sizes:
  print 'Ad unit of dimension %s x %s found.' % (ad_unit_size['size']['width'],
                                                 ad_unit_size['size']['height'])
