...
"""This example gets all operating systems available."""
...
pql_service = client.GetService(
    'PublisherQueryLanguageService', 'https://sandbox.google.com', 'v201201')

select_statement = {'query': 'SELECT * FROM Operating_System'}

# Get operating systems by statement.
